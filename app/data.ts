...
export const topics: Topic[] = [
  ...
  { slug: "deepseek-harness-architecture", category: "technical", group: "架构设计", title: "DeepSeek Harness 架构深度研究", eyebrow: "技术能力 / 架构设计 / AGENT HARNESS", description: "围绕 Cordis、Capability Seam、Agent Loop、事件溯源、沙箱、子代理与扩展生态，拆解插件式 Agent Harness。", readTime: "40 分钟", sections: [] },
